...
// Fuente de identidad: solo para títulos y cifras grandes (font-display),
// el resto de la app sigue en Geist. Le da carácter propio a ListaSuper sin
// tocar el texto de uso (inputs, listas), que se queda con Geist por su
// legibilidad y el ajuste anti auto-zoom de iOS ya resuelto.
